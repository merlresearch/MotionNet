...
from model import FeatEncoder, MotionNetMGDA
...
parser.add_argument(
    "--reg_weight_cls", default=2.0, type=float, help="The extra weight for grid cell classification term"
)
...
def train(models, criterion, trainloader, optimizers, device, epoch):
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        loss_disp, loss_class, loss_motion = compute_and_bp_loss(
            optimizers,
            device,
            future_steps[0].item(),
            all_disp_field_gt,
        ...
        print(
            "{}, \t{}, \t{}, \tat epoch {}, \titerations {}".format(
                running_loss_disp, running_loss_class, running_loss_motion, epoch, i
            )
        )
